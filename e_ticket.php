                  ...
                  if(!mysqli_stmt_prepare($stmt_f,$sql_f)) {
                      ...
                      if($row_f = mysqli_fetch_assoc($result_f)) {
                        ...
                        <div class="col-9 out">
                            ...
                            <div class="row mb-3">  
                                <div class="col-4">
                                    <p class="head">Companhia Aérea</p>
                        ...
                        <div class="col-3 bord pl-0" style="background-color:#376b8d;
                            ...
                            &nbsp Obrigado por nos escolher. </br> </br>
                                Por favor, esteja no portão no momento do embarque</h3>    
                            </div>                            
                        </div>                                                 
                        </div>                                               
                      ' ;

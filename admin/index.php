...
.dashbord-red .detail-section{
      ...
      <div class="card-body">
          <div class="dropdown" style="float: right;">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
              <a class="dropdown-item" href="#flight">Voos de hoje</a>
              <a class="dropdown-item" href="#issue">Problemas de voo de hoje</a>
              <a class="dropdown-item" href="#dep">Os voos partiram hoje</a>
              <a class="dropdown-item" href="#arr">Os voos chegaram hoje</a>
            </div>
          </div>        
        ...
        <table class="table-sm table table-hover">
          <thead class="thead-dark">
            <tr><!-- log on to codeastro.com for more projects -->
              ...
              <th scope="col">Companhias aéreas</th>
              <th>Ação</th>
            </tr>
          </thead>
    ...
    <div class="card" id="issue">
      <div class="card-body">
          <div class="dropdown" style="float: right;">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
              <a class="dropdown-item" href="#flight">Voo de hoje</a>
              <a class="dropdown-item" href="#issue">Problemas de voo de hoje</a>
              <a class="dropdown-item" href="#dep">Os voos partiram hoje</a>
              <a class="dropdown-item" href="#arr">Os voos chegaram hoje</a>
            </div>
          </div>        
        <p class="text-secondary">Problemas de voo de hoje</p>
        <table class="table-sm table table-hover">
        <thead class="thead-dark">
            <tr>
              <th scope="col">#</th>
    ...
    <div class="card" id="dep">
      <div class="card-body">
        ...
        <p class=" text-secondary">Voos Partiram Hoje</p>
        <table class="table-sm table table-hover">
        <thead class="thead-dark">
            <tr><!-- log on to codeastro.com for more projects -->
              <th scope="col">#</th>
    ...
    <div class="card mb-4" id="arr">
      <div class="card-body">
        ...
        <p class=" text-secondary">Voos chegaram hoje</p>
        <table class="table-sm table table-hover">
        <thead class="thead-dark">
            <tr><!-- log on to codeastro.com for more projects -->
              <th scope="col">#</th>

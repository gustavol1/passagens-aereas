...
<html lang="en">
    <head>
        ...
        <title>Reserva de voos on-line</title>          
        <link rel = "icon" href =  
  ...
  h4 {
    ...
    <body>
        ...
        <nav class="navbar navbar-custom navbar-expand-lg navbar-dark">
          <a class="navbar-brand text-light" href="index.php"><h4>PAINEL DE ADMIN</h4></a>
              ...
              if(isset($_SESSION['adminId'])) { ?>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="index.php">
                      <h5 class="ml-2"> Painel</h5>
                    </a>
                  </li>

                  <li class="nav-item">
                    <a class="nav-link" href="flight.php">
                      <h5 class="ml-2"> Adicionar Voos</h5>
                    </a>
                  </li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <div class="dropdown mt-2">
                      <button class="btn bg-transparent dropdown-toggle text-white" type="button" 
                        ...
                        <i class="fa fa-plus text-white"></i> Companhias Aéreas </td>
                      </button>  

...
<div class="container mt-4 mb-4">
  <h1 class="text-center mb-4 text-light">AVALIAÇÕES DE CLIENTES</h1>
  <div class="row">
    <?php
    ...
    while ($row = mysqli_fetch_assoc($result)) { 
      ...
      <div class="review-bag">  
        ...
        <p class="quest">Qual foi a sua primeira impressão ao entrar no site?</p>
        <p class="ans">'.$row['q1'].'</p>
        <p class="quest">Como você ouviu falar de nós pela primeira vez?</p>
        <p class="ans">'.$row['q2'].'</p>
        <p class="quest">Está faltando alguma coisa nesta página?</p>

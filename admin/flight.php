...
<div class="container mt-0">
  <div class="row">
    ...
    ?><!-- log on to codeastro.com for more projects -->
      ...
      <h1 class="text-secondary text-center">ADICIONAR DETALHES DO VOO</h1>
      ...
      <form method="POST" class=" text-center" 
        ...
        <div class="form-row mb-4">
          <div class="col-md-3 p-0">
            <h5 class="mb-0 form-name">PARTIDA</h5>
          </div>
        ...
        <div class="form-row mb-4">
        <div class="col-md-3 ">
            <h5 class="form-name mb-0">CHEGADA</h5>
          </div>          
          <div class="col">

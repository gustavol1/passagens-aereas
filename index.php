	...
	<div class="main-agileinfo">
		<h1 class="text-light brand mt-2">
			<img src="assets/images/airtic.png" 
				...
				Compra de Passagens Aéreas</h1>
		<div class="sap_tabs">			
			<div id="horizontalTab">
				<ul class="resp-tabs-list">
					<li class="resp-tab-item"><span>Ida e volta</span></li>
					<li class="resp-tab-item"><span>Mão Única</span></li>
				</ul>	
				...
				<div class="resp-tabs-container">
					<div class="tab-1 resp-tab-content roundtrip">
						<form action="book_flight.php" method="post">
							...
							<div class="from">
								<h3 style="color: rgba(255, 255, 255, 0.767);">De</h3>
								<?php
								...
								<option value="0" selected disabled >Partida</option>';
							...
							<div class="to">
								<h3 style="color: rgba(255, 255, 255, 0.767);">Para</h3>
								<?php
								$sql = 'SELECT * FROM Cities ';
								$stmt = mysqli_stmt_init($conn);
								mysqli_stmt_prepare($stmt,$sql);         
								...
								<option selected disabled>Chegada</option>';
								while ($row = mysqli_fetch_assoc($result)) {
								echo '<option value='. $row['city']  .'>'. 
									$row['city'] .'</option>';
								}
							...
							<div class="class">
								...
								<select id="w3_country1" 
									...
									<option value="B">Primeira Classe</option>   
								</select>
							...
							<div class="numofppl">
								<div class="adults">
									<h3 style="color: rgba(255, 255, 255, 0.767);">Passageiros</h3>
									<div class="quantity"> 
							...
							<div class="clear"></div>
							<input type="submit" value="Pesquisar Voos" name="search_but">
						</form>						
					</div>		
					<div class="tab-1 resp-tab-content oneway">
						<form action="book_flight.php" method="post">
							...
							<div class="from">
								...
								<option selected disabled>Partida</option>';
								while ($row = mysqli_fetch_assoc($result)) {
								echo '<option value='. $row['city']  .'>'. 
									$row['city'] .'</option>';
								}
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4  intro_col">
                                    <div class="intro_item d-flex flex-row align-items-end justify-content-start">
                                        ...
                                        <div class="intro_content">
                                            <div class="intro_title">Principais destinos</div>
                                            <div class="intro_subtitle">
                                                <p>O que está na sua lista de viagens?</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 intro_col">
                                    <div class="intro_item d-flex flex-row align-items-end justify-content-start">
                                        ...
                                        <div class="intro_content">
                                            <div class="intro_title">Os melhores preços</div>
                                            <div class="intro_subtitle">
                                                <p>Visite seus lugares favoritos a um preço razoável</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 intro_col">
                                    <div class="intro_item d-flex flex-row align-items-end justify-content-start">
                                        ...
                                        <div class="intro_content">
                                            <div class="intro_title">Serviços incríveis</div>
                                            <div class="intro_subtitle">
                                                <p>Grandes interações começam com o conhecimento dos desejos e necessidades de seus clientes.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<!-- <div class="conatiner-fluid p-4" style="background-color: whitesmoke;margin-top:150px;"> -->
	...
	<em><h5 class="text-light text-center p-0 brand mt-2">
				<img src="assets/images/airtic.png" 
					...
					Compra de Passagens Aéreas</h5></em>
	<div class="text-light text-center">&copy; <?php echo date('Y')?> - Desenvolvido por ST <br><br></div>
	<!-- <p>----------</p> -->

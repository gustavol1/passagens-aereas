...
--
-- Host: 127.0.0.1
-- Tempo de geração: 20-Set-2022 às 14:51
...
(1, 1, '2022-06-30 10:03:00', '2022-06-30 09:01:00', 'Chicago', 'San', 'Core Airways', '61', '1', 175, '', '', '21D', 20, ''),
...
--
-- Estrutura da tabela `passenger_profile`
--
...
--
-- Extraindo dados da tabela `passenger_profile`
--
...
(8, 5, 1, '7412585555', '1995-06-23 00:00:00', 'joão', 'a', 'Lopes');
...
('4724856943292864', 5, 1, '17/03', 350);
...
(5, 'Gustavo', 'gustavo@gmail.com', '$2y$10$GCEAES7GU5elIDu0lacig.BvFC.T89RRLuih789ueALUx8aXw.Rb6');
...
--
-- Índices para tabela `passenger_profile`
--
...
--
-- AUTO_INCREMENT de tabela `airline`
--
ALTER TABLE `airline`
...
--
-- AUTO_INCREMENT de tabela `flight`
--
ALTER TABLE `flight`
  MODIFY `flight_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT de tabela `passenger_profile`
--
ALTER TABLE `passenger_profile`
...
--
-- Limitadores para a tabela `passenger_profile`
--
ALTER TABLE `passenger_profile`

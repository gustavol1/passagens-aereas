...
td {
  ...
  color: #424242;
        ...
        <?php if(isset($_POST['search_but'])) { 
          ...
          <div class="container-md mt-2">
            <h1 class="display-4 text-center text-light"
              >VOOS DE: <br> <?php echo $dep_city; ?> 
                 para <?php echo $arr_city; ?> </h1>
              ...
              <tbody>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                  ...
                  if(isset($_SESSION['userId']) && $row['status'] === '') {   
                    ...
                    echo "<td>Faça login para continuar</td>";
                  }
                  echo '</tr> ';                 
                }
                ?>
	...
	<em><h5 class="text-light text-center p-0 brand mt-2">
			...
			Reserva de voos on-line</h5></em>
	<p class="text-light text-center">&copy; <?php echo date('Y');?> - Nossos Nomes: </p>
</footer>
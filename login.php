...
if(isset($_GET['error'])) {
    if($_GET['error'] === 'invalidcred') {
        ...
        echo"<script>alert('Erro de Banco de Dados')</script>";
    }
}
...
<div class="container mt-0">
  <div class="row">
    <div class="col-md-3"></div>
      ...
      <h1 class="text-secondary text-center">PAINEL DE LOGIN</h1>
      ...
      <form method="POST" class=" text-center" 
        ...
        <div class="form-row">  
          ...
          <div class="col-10 mb-2">              
            <div class="input-group">
                <label for="user_id">Usuário/ Email</label>
        ...
        <div class="row mt-3">
          ...
          <a id="reset-pass" class="mr-5" href="reset-pwd.php"
              style="float: right !important;">Esqueceu a senha?</a>        
          </div>         
        </div>   
        <div class="row mt-4">
          <div class="col">
            <a href="register.php">
              <button type="button" class="btn btn-info mt-3">
                ...
                <i class="fas fa-user-plus text-light"></i> Registro
                </div>
              </button>
            </a> 
          </div> 
          <div class="col">
            <button name="login_but" type="submit" 
              ...
              <div style="font-size: 1.5rem;">
              <i class="fa fa-lg fa-arrow-right"></i> Logar
              </div>
            </button>
          </div>       
        </div>       

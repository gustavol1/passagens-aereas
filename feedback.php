      ...
      <div class="row justify-content-center">  
          ...
          <div class="col-12 mt-4">
            <div class="form-group">         
              <label for="exampleFormControlTextarea1">Qual a sua primeira impressão
                  quando você entrou no site?</label>     
          ...
          <div class="col-12 mt-4">
            <div class="form-group">         
              ...
              width:100%" required>
                <option  selected disabled>Por qual meio ouvir falar de nós pela primeira vez?</option>
                <option >Motor de busca</option>
                <option >Redes sociais</option>
                <option >Amigo/parente</option>
                <option >Coditiano</option>
          ...
          <div class="col-12 mt-4">
            <div class="form-group">         
              <label for="exampleFormControlTextarea1">O que você gostaria de adicionar a página?</label>     
...
<footer>
	<em><h5 class="text-light text-center p-0 brand mt-2">
          ...
          Compra de Passagens aereas</h5></em>
	<p class="text-light text-center">&copy; <?php echo date('Y');?> - Desenvolvido por: ST</p>
</footer>
...
<?php
  if(isset($_GET['error'])) {
    if($_GET['error'] === 'sqlerror') {
      ...
      echo"<script>alert('Não há voo de volta disponível')</script>";
    } else if($_GET['error'] === 'mailerr') {
      echo"<script>alert('Erro de Busca')</script>";
    }
  }
?>
    ...
    <div class="row">
        <div class="col-12 col-sm-8 col-md-6 col-lg-4 mx-auto">
          <h1 class="text-center text-light">FATURA DE PAGAMENTO</h1>
            ...
            <form action="includes/payment.inc.php" method="post" 
                ...
                <div class="form-group">
                    ...
                    <span class="invalid-feedback">Digite um cartão válido de 12 a 16 digitos</span>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="cc-exp" class="control-label mb-1">Vencimento</label>
                    ...
                    <div class="col-6 p-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col pr-0">                            
                                <span class="invalid-feedback order-last">Digite o código de 3 digitos abaixo</span>
    ...
    if (form[0].checkValidity() === false) {
      ...
      e.stopPropagation();
       ...
       if (!regCardNo.test(CardNo)) {
        ...
        $("#cc-number").focus();
        alert(" Digite um cartão válido de 10 a 16 números");
        return false;
      }
        ...
        $("#cc_exp").focus();
        alert(" Digite uma data de vencimento válida");
        return false;
      }
